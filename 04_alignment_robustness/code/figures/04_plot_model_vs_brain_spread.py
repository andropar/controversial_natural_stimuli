"""
04_plot_model_vs_brain_spread.py
...
Reads:
  ...
  04_alignment_robustness/results/model_rdm_spreads.csv
...
def main():
    ...
    out_pdf = FIGURES_DIR / "model_vs_brain_spread.pdf"
    out_png = PNG_DIR / "model_vs_brain_spread.png"
