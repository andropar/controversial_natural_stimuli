...
- Folder: `05_controls_and_supplementary/selection_objective_validation/noise_model_validation/figures/png`
- Figures in this folder tree: 1
- Data/table-like files in this folder tree: 0
- Python scripts in this folder tree: 0
- Direct files: `noise_model_validation.png`
...
|---|---:|---|---|---|---|---|
| `noise_model_validation` | png | validation of the selection noise model | copied from `/data/home_roth/_stachelschwein/rsa_based_selection/experiments/cstim_paper/16_noise_model_validation/figures/noise_model_validation.png`; historical share path `data/tier1_analysis_derivatives/cstim_paper/16_noise_model_validation/figures/noise_model_validation.png` | `02_alignment_reliability/data/*noise*.csv`; `noise_ceiling_results.csv`; `correlation_matrix_results.csv`; `discriminability_results.csv`; `ranking_results.csv`; `05_controls_and_supplementary/selection_objective_validation/noise_model_validation/data/candidate_utilities_nc0.3.csv`; plus 5 more | `05_controls_and_supplementary/selection_objective_validation/noise_model_validation/code/figures/plot_noise_model_validation.py` | no |
