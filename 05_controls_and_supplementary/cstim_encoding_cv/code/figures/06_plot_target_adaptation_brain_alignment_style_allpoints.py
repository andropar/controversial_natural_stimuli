...
def write_summary(df: pd.DataFrame, weight: float) -> None:
    ...
    out = RESULTS_DIR / f"target_adaptation_brain_alignment_style_allpoints_w{weight:g}_summary.csv"
...
def main() -> None:
    ...
    stem = f"target_adaptation_brain_alignment_style_allpoints_w{args.weight:g}_cached"
