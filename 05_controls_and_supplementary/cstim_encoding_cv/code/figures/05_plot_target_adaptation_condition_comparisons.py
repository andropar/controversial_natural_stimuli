...
def load_wide(weight: float, model_set: str) -> pd.DataFrame:
    ...
    out_csv = RESULTS_DIR / f"target_adaptation_condition_comparison_{model_set}_w{weight:g}.csv"
...
def plot_comparison(
    ...
    *,
    ...
    stem = f"target_adaptation_1to1_{model_set}_w{weight:g}{suffix}_cached"
