...
Outputs:
    results/mrsa_layer_drop_summary.csv
    results/mrsa_layer_rescue_summary.csv
    results/mrsa_layer_drop_summary_subject_avg.csv
    results/mrsa_layer_rescue_summary_subject_avg.csv
"""
