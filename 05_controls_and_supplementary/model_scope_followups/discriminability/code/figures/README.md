...
- Folder: `05_controls_and_supplementary/model_scope_followups/discriminability/code/figures`
- Figures in this folder tree: 0
- Data/table-like files in this folder tree: 0
- Python scripts in this folder tree: 3
- Direct files: `plot_pair_separation.py`, `plot_pair_structure.py`, `plot_sample_efficiency.py`
...
| `05_controls_and_supplementary/model_scope_followups/discriminability/code/figures/plot_sample_efficiency.py` | No rendered figure output was linked by filename or literal-reference scan. | `sample_efficiency_summary.csv`; `DATA_DIR`; `FIG_DIR` |
