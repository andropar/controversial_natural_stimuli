...
- Folder: `05_controls_and_supplementary/reliability_and_residual_structure/unexplained_variance/code/figures`
- Figures in this folder tree: 0
- Data/table-like files in this folder tree: 0
- Python scripts in this folder tree: 2
- Direct files: `plot_combined.py`, `plot_subject_consistency.py`
