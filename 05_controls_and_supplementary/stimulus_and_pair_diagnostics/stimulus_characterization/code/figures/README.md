...
- Folder: `05_controls_and_supplementary/stimulus_and_pair_diagnostics/stimulus_characterization/code/figures`
- Figures in this folder tree: 0
- Data/table-like files in this folder tree: 0
- Python scripts in this folder tree: 2
- Direct files: `create_model_set_grids.py`, `create_stimulus_grids.py`
