...
- Folder: `05_controls_and_supplementary/counterfactual_baselines/code`
- Figures in this folder tree: 0
- Data/table-like files in this folder tree: 0
- Python scripts in this folder tree: 4
- Direct files: `00_compute_unique_low_level_stats.py`, `01_heldout_unique_baseline.py`, `02_summarize_heldout_unique.py`, `03_plot_matching_diagnostics.py`
