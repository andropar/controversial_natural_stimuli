...
- Folder: `00_stimulus_selection/decision_checks/selection_evaluation/method_comparison/figures`
...
|---|---:|---|---|---|---|---|
| `track_composition_leaderboard_improved` | pdf | selection-method leaderboard comparing track compositions and checkpoint choices | copied from `/data/home_roth/_stachelschwein/rsa_based_selection/scripts/claude/compare_selection_methods/figures/track_composition_leaderboard_improved.pdf` | `00_stimulus_selection/decision_checks/selection_evaluation/method_comparison/results/*.csv`; `scripts/cursor/outputs/final_aggregate_plot/leaderboard_summary.csv`; `REPO_ROOT`; `OUTPUT_DIR`; `00_stimulus_selection/decision_checks/selection_evaluation/results/all_models/ablations.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/results/all_models/correlation_matrices.csv`; plus 4 more | `00_stimulus_selection/decision_checks/selection_evaluation/method_comparison/figures/plot_track_composition_leaderboard_improved.py` | no |
