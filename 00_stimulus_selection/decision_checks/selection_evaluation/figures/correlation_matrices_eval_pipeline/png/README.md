...
- Folder: `00_stimulus_selection/decision_checks/selection_evaluation/figures/correlation_matrices_eval_pipeline/png`
- Figures in this folder tree: 10
- Data/table-like files in this folder tree: 0
- Python scripts in this folder tree: 0
- Direct files: `correlation_matrices_all_models_raw_legacy3_improved.png`, `correlation_matrices_all_models_sub-01_legacy3_improved.png`, `correlation_matrices_architecture_raw_legacy3_improved.png`, `correlation_matrices_architecture_sub-01_legacy3_improved.png`, `correlation_matrices_dataset_raw_legacy3_improved.png`, `correlation_matrices_dataset_sub-01_legacy3_improved.png`, `correlation_matrices_sota_raw_legacy3_improved.png`, `correlation_matrices_sota_sub-01_legacy3_improved.png`, `correlation_matrices_training_objective_raw_legacy3_improved.png`, `correlation_matrices_training_objective_sub-01_legacy3_improved.png`
...
|---|---:|---|---|---|---|---|
| `correlation_matrices_all_models_raw_legacy3_improved` | png | model-by-model RDM correlation matrix for the selected images and a reference baseline | copied from `/data/home_roth/_stachelschwein/rsa_based_selection/experiments/cstim_paper/00_selection_evaluation/figures/correlation_matrices_eval_pipeline/correlation_matrices_all_models_raw_legacy3_improved.png`; historical share path `data/tier1_analysis_derivatives/cstim_paper/00_selection_evaluation/figures/correlation_matrices_eval_pipeline/correlation_matrices_all_models_raw_legacy3_improved.png` | `selection_evaluation/data/*/correlation_matrices.csv`; `{which}_discriminability_{metric}_{corr_type}.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/ablations.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/correlation_matrices.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/discriminability.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/diversity.csv`; plus 2 more | `src/cstims/evaluation/plotting.py`; `src/cstims/evaluation/core.py` | no |
| `correlation_matrices_all_models_sub-01_legacy3_improved` | png | model-by-model RDM correlation matrix for the selected images and a reference baseline | copied from `/data/home_roth/_stachelschwein/rsa_based_selection/experiments/cstim_paper/00_selection_evaluation/figures/correlation_matrices_eval_pipeline/correlation_matrices_all_models_sub-01_legacy3_improved.png`; historical share path `data/tier1_analysis_derivatives/cstim_paper/00_selection_evaluation/figures/correlation_matrices_eval_pipeline/correlation_matrices_all_models_sub-01_legacy3_improved.png` | `selection_evaluation/data/*/correlation_matrices.csv`; `{which}_discriminability_{metric}_{corr_type}.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/ablations.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/correlation_matrices.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/discriminability.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/diversity.csv`; plus 2 more | `src/cstims/evaluation/plotting.py`; `src/cstims/evaluation/core.py` | no |
| `correlation_matrices_architecture_raw_legacy3_improved` | png | model-by-model RDM correlation matrix for the selected images and a reference baseline | copied from `/data/home_roth/_stachelschwein/rsa_based_selection/experiments/cstim_paper/00_selection_evaluation/figures/correlation_matrices_eval_pipeline/correlation_matrices_architecture_raw_legacy3_improved.png`; historical share path `data/tier1_analysis_derivatives/cstim_paper/00_selection_evaluation/figures/correlation_matrices_eval_pipeline/correlation_matrices_architecture_raw_legacy3_improved.png` | `selection_evaluation/data/*/correlation_matrices.csv`; `{which}_discriminability_{metric}_{corr_type}.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/ablations.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/correlation_matrices.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/discriminability.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/diversity.csv`; plus 2 more | `src/cstims/evaluation/plotting.py`; `src/cstims/evaluation/core.py` | no |
| `correlation_matrices_architecture_sub-01_legacy3_improved` | png | model-by-model RDM correlation matrix for the selected images and a reference baseline | copied from `/data/home_roth/_stachelschwein/rsa_based_selection/experiments/cstim_paper/00_selection_evaluation/figures/correlation_matrices_eval_pipeline/correlation_matrices_architecture_sub-01_legacy3_improved.png`; historical share path `data/tier1_analysis_derivatives/cstim_paper/00_selection_evaluation/figures/correlation_matrices_eval_pipeline/correlation_matrices_architecture_sub-01_legacy3_improved.png` | `selection_evaluation/data/*/correlation_matrices.csv`; `{which}_discriminability_{metric}_{corr_type}.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/ablations.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/correlation_matrices.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/discriminability.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/diversity.csv`; plus 2 more | `src/cstims/evaluation/plotting.py`; `src/cstims/evaluation/core.py` | no |
| `correlation_matrices_dataset_raw_legacy3_improved` | png | model-by-model RDM correlation matrix for the selected images and a reference baseline | copied from `/data/home_roth/_stachelschwein/rsa_based_selection/experiments/cstim_paper/00_selection_evaluation/figures/correlation_matrices_eval_pipeline/correlation_matrices_dataset_raw_legacy3_improved.png`; historical share path `data/tier1_analysis_derivatives/cstim_paper/00_selection_evaluation/figures/correlation_matrices_eval_pipeline/correlation_matrices_dataset_raw_legacy3_improved.png` | `selection_evaluation/data/*/correlation_matrices.csv`; `{which}_discriminability_{metric}_{corr_type}.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/ablations.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/correlation_matrices.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/discriminability.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/diversity.csv`; plus 2 more | `src/cstims/evaluation/plotting.py`; `src/cstims/evaluation/core.py` | no |
| `correlation_matrices_dataset_sub-01_legacy3_improved` | png | model-by-model RDM correlation matrix for the selected images and a reference baseline | copied from `/data/home_roth/_stachelschwein/rsa_based_selection/experiments/cstim_paper/00_selection_evaluation/figures/correlation_matrices_eval_pipeline/correlation_matrices_dataset_sub-01_legacy3_improved.png`; historical share path `data/tier1_analysis_derivatives/cstim_paper/00_selection_evaluation/figures/correlation_matrices_eval_pipeline/correlation_matrices_dataset_sub-01_legacy3_improved.png` | `selection_evaluation/data/*/correlation_matrices.csv`; `{which}_discriminability_{metric}_{corr_type}.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/ablations.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/correlation_matrices.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/discriminability.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/diversity.csv`; plus 2 more | `src/cstims/evaluation/plotting.py`; `src/cstims/evaluation/core.py` | no |
...
| `correlation_matrices_training_objective_raw_legacy3_improved` | png | model-by-model RDM correlation matrix for the selected images and a reference baseline | copied from `/data/home_roth/_stachelschwein/rsa_based_selection/experiments/cstim_paper/00_selection_evaluation/figures/correlation_matrices_eval_pipeline/correlation_matrices_training_objective_raw_legacy3_improved.png`; historical share path `data/tier1_analysis_derivatives/cstim_paper/00_selection_evaluation/figures/correlation_matrices_eval_pipeline/correlation_matrices_training_objective_raw_legacy3_improved.png` | `selection_evaluation/data/*/correlation_matrices.csv`; `{which}_discriminability_{metric}_{corr_type}.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/ablations.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/correlation_matrices.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/discriminability.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/diversity.csv`; plus 2 more | `src/cstims/evaluation/plotting.py`; `src/cstims/evaluation/core.py` | no |
| `correlation_matrices_training_objective_sub-01_legacy3_improved` | png | model-by-model RDM correlation matrix for the selected images and a reference baseline | copied from `/data/home_roth/_stachelschwein/rsa_based_selection/experiments/cstim_paper/00_selection_evaluation/figures/correlation_matrices_eval_pipeline/correlation_matrices_training_objective_sub-01_legacy3_improved.png`; historical share path `data/tier1_analysis_derivatives/cstim_paper/00_selection_evaluation/figures/correlation_matrices_eval_pipeline/correlation_matrices_training_objective_sub-01_legacy3_improved.png` | `selection_evaluation/data/*/correlation_matrices.csv`; `{which}_discriminability_{metric}_{corr_type}.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/ablations.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/correlation_matrices.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/discriminability.csv`; `00_stimulus_selection/decision_checks/selection_evaluation/data/all_models/diversity.csv`; plus 2 more | `src/cstims/evaluation/plotting.py`; `src/cstims/evaluation/core.py` | no |
