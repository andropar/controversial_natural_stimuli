#!/usr/bin/env python3
"""Plot feature-method teacher/student RDM-score recovery curves."""
...
DEFAULT_FIGURES = SWEEP_ROOT / "figures"
METHOD_ORDER = [
    "raw_only_mean_min",
    "sub01_only_mean_min",
...
def plot_curves(summary: pd.DataFrame, out_base: Path) -> None:
    ...
    fig.suptitle("Feature-method sweep teacher/student RDM-score recovery", y=1.15)
    fig.tight_layout()
...
def main() -> None:
    ...
    parser.add_argument("--name", default="feature_method_sweep_teacher_student_rdm_score")
