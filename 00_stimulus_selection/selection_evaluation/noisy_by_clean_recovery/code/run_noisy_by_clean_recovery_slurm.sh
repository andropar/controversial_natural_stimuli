...
SCRIPT="${ROOT}/00_stimulus_selection/selection_evaluation/noisy_by_clean_recovery/code/compute_noisy_by_clean_recovery.py"
PLOT="${ROOT}/00_stimulus_selection/selection_evaluation/noisy_by_clean_recovery/code/plot_noisy_by_clean_recovery.py"
PAIRWISE_PLOT="${ROOT}/00_stimulus_selection/selection_evaluation/noisy_by_clean_recovery/code/plot_pairwise_margin.py"
