#!/usr/bin/env python3
"""Plot independent-refit teacher/student recovery outputs."""
...
def main() -> None:
    ...
    plot.make_figure("auc", "teacher_student_independent_refit_1k")

    pairwise = load_module("pairwise_plot", PAIRWISE_PLOT)
    pairwise.DATA_SUFFIX = DATA_SUFFIX
    pairwise.OUTPUT_PREFIX = "teacher_student_independent_refit_1k_"
