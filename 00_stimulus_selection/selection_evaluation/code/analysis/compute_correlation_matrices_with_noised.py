...
# Layer-name lookup direct from model_list.csv. Do not use paths.model_layer_mapping()
# here: the vicco cache uses raw dotted layer names, not encoding folder tags.
