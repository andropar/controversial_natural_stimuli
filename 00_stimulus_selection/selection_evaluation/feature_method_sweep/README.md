...
```bash
bash 00_stimulus_selection/selection_evaluation/feature_method_sweep/code/run_feature_method_sweep_slurm.sh
```
...
```text
00_stimulus_selection/selection_evaluation/feature_method_sweep/results/
```
