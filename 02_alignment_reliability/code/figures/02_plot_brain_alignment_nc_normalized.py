...
Outputs:
    02_alignment_reliability/figures/brain_alignment_nc_normalized.pdf
    02_alignment_reliability/figures/png/brain_alignment_nc_normalized.png

Usage:
    python 02_alignment_reliability/code/figures/02_plot_brain_alignment_nc_normalized.py
"""
