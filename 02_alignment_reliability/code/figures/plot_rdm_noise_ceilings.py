...
Inputs:
    data/rdm_noise_ceilings.csv

Outputs:
    figures/rdm_noise_ceilings.pdf/png

Usage:
    python plot_rdm_noise_ceilings.py
"""
...
from style_improved import apply_style, FONT, DPI, W_SINGLE
