...
Inputs:
  experiments/cstim_fmri_analysis/data/{sub}/cstim_betas_by_rep.npz
  experiments/cstim_fmri_analysis/data/{sub}/cstim_stimulus_info.csv
  experiments/cstim_fmri_analysis/data/{sub}/voxel_metadata.npz

Outputs:
  experiments/cstim_fmri_analysis/data/rdm_noise_ceilings.csv

Usage:
  python 08_compute_noise_ceilings.py [--subject sub-05 | --subject all]
"""
...
def process_subject(subject: str) -> list[dict]:
    ...
    # Vicco: bootstrap 10 samples of 100
...
def main():
    ...
    output_path = config.STATS_DATA_DIR / "rdm_noise_ceilings.csv"
